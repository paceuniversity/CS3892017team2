...
public class Changsha extends AppCompatActivity {
    ...
    public void init(){
        ...
        b2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Changsha.this,Map.class);
    ...
    public void init2(){
        ...
        b3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Changsha.this,Train.class);
                startActivity(intent);
            }
        });
    }
    public void init3(){
        ...
        b4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Changsha.this,History.class);
                startActivity(intent);
            }
        });
    }
    public void init4() {
        ...
        b5.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Changsha.this,Store.class);
                startActivity(intent);
            }
        });
    }
    public void init5() {
        ...
        b6.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Changsha.this,Setting.class);
                startActivity(intent);
            }
        });
    }
