...
public class Chengdu extends AppCompatActivity {
    ...
    public void init(){
        ...
        b2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Chengdu.this,Map.class);
    ...
    public void init2(){
        ...
        b3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Chengdu.this,Train.class);
                startActivity(intent);
            }
        });
    }
    public void init3(){
        ...
        b4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Chengdu.this,History.class);
                startActivity(intent);
            }
        });
    }
    public void init4() {
        ...
        b5.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Chengdu.this,Store.class);
                startActivity(intent);
            }
        });
    }
    public void init5() {
        ...
        b6.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Chengdu.this,Setting.class);
                startActivity(intent);
            }
        });
    }
