...
public class Linzi extends AppCompatActivity {
    ImageButton b2, b3, b4, b5, b6;
    public void init(){
        b2 = (ImageButton) findViewById(R.id.map_navbar);
        b2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Linzi.this,Map.class);
    ...
    public void init2(){
        ...
        b3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Linzi.this,Train.class);
                startActivity(intent);
            }
        });
    }
    public void init3(){
        ...
        b4.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Linzi.this,History.class);
                startActivity(intent);
            }
        });
    }
    public void init4() {
        ...
        b5.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Linzi.this,Store.class);
                startActivity(intent);
            }
        });
    }
    public void init5() {
        ...
        b6.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(Linzi.this,Setting.class);
                startActivity(intent);
            }
        });
    }
